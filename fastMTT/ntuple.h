...
// Mon Jul 28 21:27:15 2025 by ROOT version 6.30/07
// from TTree ntuple/
// found on file: root://eoscms.cern.ch//eos/cms/store/group/phys_tau/ksavva/For_Aliaksei/files/testingzpt/Run3_2022/mt/GluGluHTo2Tau_UncorrelatedDecay_SM_Filtered_ProdAndDecay/nominal/merged.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Double_t        aco_mu_rho;
   Double_t        aco_mu_a1;
   Double_t        aco_mu_a1_FASTMTT_NoMassConstraint;
   ...
   TBranch        *b_aco_mu_a1;   //!
   TBranch        *b_aco_mu_a1_FASTMTT_NoMassConstraint;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://eoscms.cern.ch//eos/cms/store/group/phys_tau/ksavva/For_Aliaksei/files/testingzpt/Run3_2022/mt/GluGluHTo2Tau_UncorrelatedDecay_SM_Filtered_ProdAndDecay/nominal/merged.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://eoscms.cern.ch//eos/cms/store/group/phys_tau/ksavva/For_Aliaksei/files/testingzpt/Run3_2022/mt/GluGluHTo2Tau_UncorrelatedDecay_SM_Filtered_ProdAndDecay/nominal/merged.root");
      }
...
void ntuple::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("aco_mu_a1_FASTMTT_NoMassConstraint", &aco_mu_a1_FASTMTT_NoMassConstraint, &b_aco_mu_a1_FASTMTT_NoMassConstraint);
