...
def Plot(hists,**kwargs):
    ...
    styles.InitHist(h_lep,"","",ROOT.TColor.GetColor("#4496C8"),1001)
    ...
    outputGraphics = os.getenv('PWD') + '/figures/' + var + '_' + chan + '_' + era + '_' + typ_suffix + suffix + '.png'    
...
if __name__ == "__main__":
    ...
    Plot(hists,era=era,var=var,channel=chan,per_process=proc,suffix=suffix,ymin=ymin,ymax=ymax)
