...
#./scripts/PlotZll.py --era ${era} --channel ${chan} --variable m_vis --nbins 43 --xmin 60 --xmax 146 --applyIP1 ${applyIP1} --applyIP2 ${applyIP2} --applySF ${applySF} --generator ${generator} --calibrDY ${calibrDY}
