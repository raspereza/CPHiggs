...
./scripts/PlotZtautau.py --era ${era} --channel ${chan} --variable jpt_1 --nbins 17 --xmin 30 --xmax 200 --applyIP ${ip} --applySF ${sf} --useCrossTrigger ${xtrig} --generator ${generator} --calibrWJ ${calibrWJ}
./scripts/PlotZtautau.py --era ${era} --channel ${chan} --variable jpt_2 --nbins 17 --xmin 30 --xmax 200 --applyIP ${ip} --applySF ${sf} --useCrossTrigger ${xtrig} --generator ${generator} --calibrWJ ${calibrWJ}
