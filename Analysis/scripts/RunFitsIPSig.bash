...
era=$1
chan=$2
cd /afs/cern.ch/work/r/rasp/CPHiggs/Analysis/datacardsIpSig
...
do
	...
	combineTool.py -M FitDiagnostics --saveNormalizations --saveShapes --saveWithUncertainties --saveNLL --redefineSignalPOIs r_pass,r_fail -m 91 --robustHesse 1 -d ${name}.root --cminDefaultMinimizerTolerance 0.1 --cminDefaultMinimizerStrategy 1 -v 2
