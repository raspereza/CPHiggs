...
// Mon Mar 23 08:49:56 2026 by ROOT version 6.30/07
// from TTree ntuple/
// found on file: root://eoscms.cern.ch//eos/cms/store/group/phys_tau/lrussell/forAliaksei/ForFakeFactors/Run3_2022EE/et/EGamma_Run2022E/nominal/merged.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://eoscms.cern.ch//eos/cms/store/group/phys_tau/lrussell/forAliaksei/ForFakeFactors/Run3_2022EE/et/EGamma_Run2022E/nominal/merged.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://eoscms.cern.ch//eos/cms/store/group/phys_tau/lrussell/forAliaksei/ForFakeFactors/Run3_2022EE/et/EGamma_Run2022E/nominal/merged.root");
      }
