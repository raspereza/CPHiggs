...
// Mon Jan  6 17:04:41 2025 by ROOT version 6.30/07
// from TTree ntuple/
// found on file: root://eoscms.cern.ch//eos/cms/store/group/phys_tau/ksavva/For_Aliaksei/files/testingzpt/Run3_2023/et/DYto2L_M_50_madgraphMLM/nominal/merged.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Double_t        aco_e_rho;
   Double_t        aco_e_a1;
   Double_t        aco_e_a1_FASTMTT_NoMassConstraint;
   ...
   Double_t        w_Electron_Reco_Up;
   Double_t        w_Electron_Reco_Down;
   Double_t        iso_1;
   ...
   TBranch        *b_aco_e_rho;   //!
   TBranch        *b_aco_e_a1;   //!
   TBranch        *b_aco_e_a1_FASTMTT_NoMassConstraint;   //!
   ...
   TBranch        *b_w_Electron_Reco_Up;   //!
   TBranch        *b_w_Electron_Reco_Down;   //!
   TBranch        *b_iso_1;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://eoscms.cern.ch//eos/cms/store/group/phys_tau/ksavva/For_Aliaksei/files/testingzpt/Run3_2023/et/DYto2L_M_50_madgraphMLM/nominal/merged.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://eoscms.cern.ch//eos/cms/store/group/phys_tau/ksavva/For_Aliaksei/files/testingzpt/Run3_2023/et/DYto2L_M_50_madgraphMLM/nominal/merged.root");
      }
...
void ntuple::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("aco_e_a1_FASTMTT_NoMassConstraint", &aco_e_a1_FASTMTT_NoMassConstraint, &b_aco_e_a1_FASTMTT_NoMassConstraint);
   ...
   fChain->SetBranchAddress("w_Electron_Reco_Up", &w_Electron_Reco_Up, &b_w_Electron_Reco_Up);
   fChain->SetBranchAddress("w_Electron_Reco_Down", &w_Electron_Reco_Down, &b_w_Electron_Reco_Down);
